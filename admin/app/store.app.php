...
class StoreApp extends BackendApp
{
    ...
    function index()
    {
        ...
        $stores = $this->_store_mod->find(array(
            ...
            'join'  => 'belongs_to_user,has_storebehalfarea,has_storerealityzone,has_storebrandarea',
            'fields'=> 'this.*,member.user_name,sbehalfarea.state as behalf_area,srealityzone.state as realityzone,sbrandarea.state as brand_area',
            'limit' => $page['limit'],
            'count' => true,
